...
// cargo run --bin store -- x_pubsub_topic_x
// cargo run --bin store -- x_pubsub_topic_x /ip4/127.0.0.1/tcp/xxxxx

use libp2p::futures::StreamExt;
use libp2p::{identity::Keypair, swarm::Swarm, Multiaddr, PeerId};
use log::info;
use std::error::Error;
use waku_protocol::waku_store::network_behaviour::WakuStoreBehaviour;
